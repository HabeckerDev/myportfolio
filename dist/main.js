...
loader.load( 'Penny.gltf', function ( gltf ) {
  ...
  const pennyTexture = new THREE.TextureLoader().load('Penny.png', function (texture) {
...
const aiTexture = new THREE.TextureLoader().load('aibg.jpg');
scene.background = aiTexture;

// Avatar

const dylanTexture = new THREE.TextureLoader().load('dylan.jpg');
